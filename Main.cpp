...
#include "./VectorFiles/Quaternion.h" // TODO: ADD GH
...
int main()
{
	...
	//_Vctr1.rotate(Xmtrx).printvector(); // DISCLAIMER: all rotate functions are bugged other than for Vector2, it will be worked on
    ...
    Vctr_2d.rotate(Rotationmtrx_2D).printvector(); // and here is how you call your rotation function while printing
	...
	std::cout << _Vctr1.angle(_Vctr1.resultant(Vctr2)) << std::endl;
...
//    // TODO comment out all of this part [gh]
